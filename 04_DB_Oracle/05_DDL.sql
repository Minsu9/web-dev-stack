...
-- USER_TABLES : 사용자가 가지고 있는 테이블들 상의 모든 컬럼의
--                 전반적인 구조를 확인할 수 있는 시스템 테이블
...
INSERT INTO MEM_NOTNULL VALUES(1, 'user01', 'pass01', '윤의진',
     '남', '010-1111-2222', 'aaa@naver.com', '25/06/05');
INSERT INTO MEM_NOTNULL(MEM_NO, MEM_ID, MEM_PWD, MEM_NAME) 
...
INSERT INTO MEM_UNIQUE VALUES(1, 'user01', 'pass01', '윤의진',
     '남', '010-1111-2222', 'aaa@naver.com', '25/06/05');
INSERT INTO MEM_UNIQUE(MEM_NO, MEM_ID, MEM_PWD, MEM_NAME) 
        VALUES(2, 'user02', 'pass02', '이진용', SYSDATE);
...
/*
     ...
     - PRIMARY KEY 제약조건을 부여하면 그 컬럼은 
          자동으로 NOT NULL + UNIQUE 제약조긴이 설정됨
...
INSERT INTO MEM_PRI VALUES(1, 'user01', 'pass01', '윤의진',
     '남', '010-1111-2222', 'aaa@naver.com', '25/06/05');
...
INSERT INTO MEM_PRI2 (MEM_ID, MEM_PWD, MEM_NAME, 
...
CREATE TABLE MEM_MEMBER(
    ...
    MEM_PWD VARCHAR2(20) NOT NULL,
    MEM_NAME VARCHAR2(20) NOT NULL,
    GRADE_ID NUMBER -- 회원등급번호 보관할 컬럼 만들기
);
...
/*
     ...
     --> 다른 테이블을 참조한다고 표현
     --> 주로 FOREIGN KEY 제약조건에 의해 테이블 간에 관계가 형성
*/
...
INSERT INTO MEM_MEMBE2R(MEM_ID, MEM_PWD, MEM_NAME, GRADE_ID)
VALUES('user01', 'pass01', '윤의진', 1);
...
--       PUB_NO - 숫자, 외래키
--               (PUBLISHER의 PUN_NO, 삭제 조건 CASCADE)
CREATE TABLE BOOK(
...
CREATE TABLE RENT(
     ...
     BK_NO REFERENCES BOOK(BK_NO) ON DELETE SET NULL
);
