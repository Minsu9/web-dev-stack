/*
    ...
    1. DML(Data Manipulation Language) : 데이터 조작어
       ...
       - SELECT는 데이터 조회를 의미하며 일부에서는 DQL(Data Query Language로)
    C reate - 추가 = INSERT
    R ead - 조회 = SELECT
    U pdate - 수정 = UPDATE
    D elete - 삭제 = DELETE
...
*/
-- USER_INFO에서 나이(AGE)에 10년 후 를 계산
SELECT 
    NAME 이름 
    AGE 나이 
    AGE + 10 "10년 후" 
...
-- SELECT DISTINCT AGE, DISTINCT MBTI FROM USER_INFO 쓸 수 없는 예시
